...
- IframeChatbot component available for full-screen overlay with close button
...
- When Circle T logo is detected via QR code or AI detection, it shows regular chat messages
